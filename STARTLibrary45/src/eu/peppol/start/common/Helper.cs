...
namespace STARTLibrary.src.eu.peppol.start.common
{
    public class Helper
    {
        ...
        //don't want this for client-code
        ///// <summary>
        ///// Make Peppol Exception
        ///// </summary>        
        ///// <returns>Throw an exception</returns>
        //public FaultException MakePeppolException(string subCode, string reason, Exception innerException)
        //{
        //    return new FaultException(new FaultReason(reason),new FaultCode("Sender", "http://schemas.xmlsoap.org/soap/envelope/",new FaultCode(subCode, "http://bden")), "http://busdox.org/2010/02/channel/fault");
        //}
    }
}
